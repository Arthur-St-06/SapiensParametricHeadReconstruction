...
def run_fitting():
    img_folder_path = '/home/arthur/ParametricHeadReconstruction/dataset/direct_neutral_scans'
    for filename in os.listdir(img_folder_path):
        print(f'Working on {filename}')
        # input scan
        scan_path = f'/home/arthur/ParametricHeadReconstruction/dataset/direct_neutral_scans/{filename}'

        # landmarks of the scan
        scan_lmk_path = f'/home/arthur/ParametricHeadReconstruction/dataset/direct_neutral_landmarks/numpy/{filename[:-4]}_kpt3d.npy'
        ...
        # model
        model_path = 'flame-fitting/models/generic_model.pkl' # change to 'female_model.pkl' or 'male_model.pkl', if gender is known
        ...
        # write result
        output_path = join( output_dir, f'{filename}_fit_scan_result.obj' )
        ...
        output_path = join( output_dir, f'{filename}_scan_scaled.obj' )    
